...
function App() {
  ...
  return (
    <main>
      <h1>Hi, I'm Victor Maina</h1>
      <img alt="My profile pic" src="https://via.placeholder.com/350" />
      <h2>About Me</h2>
      <p>
        I am an aspiring Software Developer currently enrolled at Moringa School. I would like to bring more ideas to life.
      </p>
      {showMessage ? displayMessage : displayForm}

      <div>
        <a href="https://github.com/smigthereason">GitHub</a>
        <a href="https://www.linkedin.com/in/victor-maina-389318301/">LinkedIn</a>
      </div>
    </main>
  );
}
